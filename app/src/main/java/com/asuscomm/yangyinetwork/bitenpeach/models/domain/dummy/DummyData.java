...
//        String q = "방금 전화드린 서울에사는 신재영입니다! 사돈집에 보낼꺼 3만원짜리루 단단한거루 보내주세요! 주소: 서울 은평구 불광1동 643번지 북한힐스테이트 7차115동 조재영 Hp 010-6721-3773";
        String q = "방금 전화드린 서울에사는 신재영입니다! 사돈집에 보낼꺼 3만원짜리루 단단한거루 보내주세요! 주소: 서울 은평구 불광1동 643번지 북한힐스테이트 7차115동 조재영 Hp tel:010-6721-3773";
//        String q = "주문 드립니다. 12과 백도로 부탁 드립니다. 받는이 유형태 01037837071 세종시 연서면 부국길 17번지 입니다. 감사합니다.";
    ...
    public static RawText getDummyRawText2() {
//        String q = "서울시 동대문구 용두동 193-25번지로 복숭아 3만원 짜리 2박스 보내주세요. 받는사람은 김훈영이고 전화번호는 01041521166 입니다";
//        String q = "방금 전화드린 서울에사는 신재영입니다! 사돈집에 보낼꺼 3만원짜리루 단단한거루 보내주세요! 주소: 서울 은평구 불광1동 643번지 북한힐스테이트 7차115동 조재영 Hp 010-6721-3773";
        String q = "이우진, 백도, 12과, 12박스 입니다.";
        String phoneNumber = "01067213773";
        RawText rawText = new RawText(phoneNumber,q);
        return rawText;
    }
